...
public class FirstStoryPage extends BasePage {
	...
	public static final String FIRST_STORY_URL = getEndavaWebSiteUrlEn() + "/Success-Stories/Retail-Enhancing-a-Social-Awareness-Campaign-with-a-new-Interaction-Model";
